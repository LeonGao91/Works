...
public class BlogFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		currentView = inflater.inflate(R.layout.fragment_blog, container, false);
		list = (ListView) currentView.findViewById(R.id.blog_list);
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				TextView blog_guid = (TextView) view.findViewById(R.id.blog_guid);
		...
		adapter = new BlogAdapter(getActivity(), feedsList);
