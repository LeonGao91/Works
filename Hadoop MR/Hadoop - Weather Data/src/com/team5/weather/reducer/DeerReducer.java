...
public class DeerReducer extends Reducer<Text, Text, Text, DoubleWritable>
{
     ...
     * deer. The rate ranges in [0, 4], and the higher,
    ...
    private double HuntRate(double[] dimensions)
    {
        ...
        double temperatureRating = (dimensions[2] > -11.1 && dimensions[2] < 44.4) ? 1
                : 1 - Math.abs((dimensions[2] - 16.65) / 16.65);
        ...
        double humidity = Math
                .pow(((112 - 0.1 * dimensions[2] / 10.0 + dimensions[3] / 10.0) / (112 + 0.9 * dimensions[2] / 10.0)),
                        8) * 100;
        double humidityRating = (humidity > 40 && humidity < 50) ? 1 : 1 - Math
                .abs((humidity - 45) / 45.0);
