...
public class TurkeyMapper extends Mapper<LongWritable, Text, Text, Text>
{
    ...
    /**
     * Test whether the specified time is good for hunting turkey
    ...
    {
        return (calendar.get(GregorianCalendar.MONTH) == GregorianCalendar.NOVEMBER)
                && (calendar.get(GregorianCalendar.DAY_OF_MONTH) >= 1)
                && (calendar.get(GregorianCalendar.DAY_OF_MONTH) <= 29);
    }
}
